...
import com.example.dapm_food.Chef.ChefAdapter.ChefPreparedOrderViewAdapter;
import com.example.dapm_food.Chef.ChefModel.Chef;
import com.example.dapm_food.Chef.ChefModel.ChefFinalOrders;
import com.example.dapm_food.Chef.ChefModel.ChefFinalOrders1;
    ...
    private void CheforderdishesView() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                number.setText("+84" + chefFinalOrders1.getMobileNumber());
