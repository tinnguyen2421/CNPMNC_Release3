            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    user.updatePhoneNumber(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(CustomerPhoneSendOTP.this, "Cập nhật số điện thoại", Toast.LENGTH_SHORT).show();
                            } else {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                        ...
                        Toast.makeText(CustomerPhoneSendOTP.this, "Gửi", Toast.LENGTH_SHORT).show();
                        verificationId = s;
                    }
