package com.example.dapm_food.Customerr.CustomerActivity;
...
import com.example.dapm_food.Customerr.CustomerModel.CustomerPaymentOrders;
import com.example.dapm_food.Customerr.CustomerModel.CustomerPaymentOrders1;
import com.example.dapm_food.BottomNavigation.CustomerFoodPanel_BottomNavigation;
import com.example.dapm_food.R;
import com.example.dapm_food.SendNotification.APIService;
import com.example.dapm_food.SendNotification.Client;
import com.example.dapm_food.SendNotification.Data;
import com.example.dapm_food.SendNotification.MyResponse;
import com.example.dapm_food.SendNotification.NotificationSender;
                                                                                            ...
                                                                                            public void onSuccess(Void aVoid) {
                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(ChefID).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        sendNotifications(usertoken, "Xác nhận đặt hàng", "Chế độ thanh toán được người được xác nhận, Bây giờ bạn có thể bắt đầu đặt hàng", "Confirm");
                                                                                                    }
