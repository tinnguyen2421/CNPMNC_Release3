...
public class CustomerCartAdapter extends RecyclerView.Adapter<CustomerCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.PriceRs.setText("Giá : " + cart.getPrice()+"VNĐ");
        holder.Qty.setText("x" + cart.getDishQuantity());
        holder.Totalrs.setText("Tổng tiền:" + cart.getTotalprice()+"VNĐ");
        ...
        CustomerCartFragment.grandt.setText("Tổng cộng:" + total+"VNĐ");
