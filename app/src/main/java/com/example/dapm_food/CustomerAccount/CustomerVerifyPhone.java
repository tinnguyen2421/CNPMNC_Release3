package com.example.dapm_food.CustomerAccount;
...
//dùng linkWithCredential để liên kết tài khoản với số điện thoại
                ...
                .addOnCompleteListener(CustomerVerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            ReusableCodeForAll.ShowAlert(CustomerVerifyPhone.this,"Lỗi","Xác nhận số điện thoại thất bại");
                        }
                    }
                });
    }
...
//        );
        ...
        // bắt đầu quá trình xác thực số điện thoại đã gán chi options
